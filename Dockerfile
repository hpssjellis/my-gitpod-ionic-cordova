...
RUN mkdir -p /home/gitpod/rocksetta                                                                            \ 
    ...
    && echo "Try installing cordova, ionic, qrcode, @ionic/lab, cordova-res, native-run  @capacitor/core @capacitor/cli" >> /home/gitpod/rocksetta/logs/mylogs.txt  \
    && npm install -g cordova ionic qrcode @ionic/lab cordova-res native-run @capacitor/core @capacitor/cli                                 \
